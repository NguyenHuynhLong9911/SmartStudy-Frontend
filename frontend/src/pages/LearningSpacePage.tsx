...
import { BookOpen, CheckCircle2, FileText, Info, UploadCloud } from 'lucide-react';
import { Badge, Card, LoadingSpinner } from '../components';
      ...
      <div className="space-y-6">
        ...
        <Card className="space-y-4 p-6">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-bold text-[#181C1E]">AI features are temporarily disabled</h2>
          </div>
          <p className="text-sm leading-relaxed text-[#404751]">
            The current AWS deployment is focused on Cognito authentication, API Gateway, Lambda, S3 upload, and PostgreSQL metadata storage.
            RAG chat, summaries, quizzes, and Bedrock processing are intentionally paused so PDF upload can be verified first.
          </p>
          <div className="rounded-xl border border-[#E0E3E5] bg-[#F4F7F9] p-4 text-sm text-[#404751]">
            Once the AI pipeline is re-enabled, this page can show PDF-aware chat, summaries, citations, and generated quizzes for the selected document.
          </div>
        </Card>
      </div>
    </div>
